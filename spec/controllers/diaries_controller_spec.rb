...
RSpec.describe DiariesController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested diary as @diary" do
      diary = Diary.create! valid_attributes
      get :show, params: {id: diary.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested diary as @diary" do
      diary = Diary.create! valid_attributes
      get :edit, params: {id: diary.to_param}, session: valid_session
      expect(assigns(:diary)).to eq(diary)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Diary" do
        expect {
          post :create, params: {diary: valid_attributes}, session: valid_session
        }.to change(Diary, :count).by(1)
      end

      it "assigns a newly created diary as @diary" do
        post :create, params: {diary: valid_attributes}, session: valid_session
        expect(assigns(:diary)).to be_a(Diary)
        expect(assigns(:diary)).to be_persisted
      end
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved diary as @diary" do
        post :create, params: {diary: invalid_attributes}, session: valid_session
        expect(assigns(:diary)).to be_a_new(Diary)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested diary" do
        diary = Diary.create! valid_attributes
        put :update, params: {id: diary.to_param, diary: new_attributes}, session: valid_session
        diary.reload
      ...
      it "assigns the requested diary as @diary" do
        diary = Diary.create! valid_attributes
        put :update, params: {id: diary.to_param, diary: valid_attributes}, session: valid_session
        expect(assigns(:diary)).to eq(diary)
      end
    ...
    context "with invalid params" do
      it "assigns the diary as @diary" do
        diary = Diary.create! valid_attributes
        put :update, params: {id: diary.to_param, diary: invalid_attributes}, session: valid_session
        expect(assigns(:diary)).to eq(diary)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested diary" do
      diary = Diary.create! valid_attributes
      expect {
        delete :destroy, params: {id: diary.to_param}, session: valid_session
      }.to change(Diary, :count).by(-1)
    end
